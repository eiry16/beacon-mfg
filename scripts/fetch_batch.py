...
JOBS = {
    "精密机械加工": (["CNC加工", "数控加工", "精密机械"], ["深圳", "东莞", "苏州", "宁波"]),
    "钣金冲压": (["钣金加工", "激光切割", "冲压"], ["深圳", "东莞", "苏州"]),
    "注塑成型": (["注塑加工", "注塑成型"], ["深圳", "东莞", "苏州"]),
    "压铸": (["压铸"], ["东莞", "深圳", "宁波"]),
    "电子元器件": (["PCB", "PCBA", "连接器"], ["深圳", "东莞", "苏州"]),
    "表面处理": (["阳极氧化", "电镀", "喷涂"], ["东莞", "深圳"]),
    "标准件": (["紧固件", "轴承"], ["深圳", "东莞", "宁波"]),
    "原材料": (["铝合金", "不锈钢"], ["佛山", "苏州", "无锡"]),
}
