...
**中文数据集**（`data/gb/`，国标四级归档）：**29942 条记录**（其中 **18535 条电话已核实**，**11407 条待核实**），拆为 **23 个国标大类**（含未归类）：
...
**英文数据集**（`data/en/gb/`，与中文同构的国标归档）：**24085 条英文镜像**，与中文按 `id` 一一对应（`en_backfill.py` 增量补齐 + `en_sync_industry.py` 补 `industry_en` 标签），供海外 Agent/买家使用。
