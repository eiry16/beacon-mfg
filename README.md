...
[![Records](https://img.shields.io/badge/records-20264-58a6ff)](data/)
[![Categories](https://img.shields.io/badge/categories-8-58a6ff)](data/index.json)
[![Industry](https://img.shields.io/badge/industry-GB%2FT%204754--2017%20%C2%B747%20%E5%B0%8F%E7%B1%BB-orange)](data/industry-index.json)
...
│   ├── industry-index.json     # 【新】GB/T 4754 国标行业索引：代码 → 企业 ID 列表
...
**中文数据集**（`data/suppliers/`）：**20264 条记录**，覆盖 8 个品类（其中 **12692 条电话已核实**，**7571 条待核实**）：

| 品类 | 总记录 | 电话已核实 | 待核实 |
|---|---|---|---|
| 精密机械加工 | 4816 | 2571 | 2245 |
| 钣金冲压 | 1950 | 1454 | 496 |
| 注塑成型 | 3139 | 1398 | 1741 |
| 压铸 | 732 | 393 | 339 |
| 电子元器件 | 1107 | 660 | 446 |
...
**英文数据集**（`data/en/`）：**20264 条英文镜像**，供海外 Agent/买家使用（与中文记录按 `id` 一一对应；其中 19610 条带 `industry_en` 英文国标小类名，与中文归类数一致）。
...
> 五城均已铺满全部 8 个品类（此前杭州只覆盖 3 个）。

> 检索优化：按城市查询用 `data/region-index.json`，**按行业查询用 `data/industry-index.json`**，都无需全量扫描品类文件。
...
- **19610 / 20264 条已归类**，覆盖 **48 个国标小类**；654 条未归类（公司名无行业信号，或属于本数据集不覆盖的门类）
...
|---|---|---|
| 3484 | 机械零部件加工 | 3513 |
| 2929 | 塑料零件及其他塑料制品制造 | 2022 |
| 3360 | 金属表面处理及热处理加工 | 1666 |
| 3311 | 金属结构制造 | 1511 |
| 3399 | 其他未列明金属制品制造 | 1374 |
| 3525 | 模具制造 | 1105 |
| 3482 | 紧固件制造 | 878 |
| 3130 | 钢压延加工 | 820 |
| 3451 | 滚动轴承制造 | 782 |
| 3483 | 弹簧制造 | 738 |
| 3989 | 其他电子元件制造 | 597 |
| 5164 | 金属及金属矿批发（非制造） | 589 |

大类分布：通用设备制造业 6042、金属制品业 5675、橡胶和塑料制品业 2198、批发业 1414、专用设备制造业 1120、计算机通信和其他电子设备制造业 962。
...
├── data/                      # 供应商数据（中文 + 英文镜像）
│   ├── index.json             # 品类 → 关键词 → 文件路径 索引
│   ├── industry-index.json    # GB/T 4754 国标行业索引（代码 → 企业 ID）
