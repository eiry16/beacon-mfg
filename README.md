...
[![Records](https://img.shields.io/badge/records-127569-58a6ff)](data/)
...
**中文数据集**（`data/gb/`，国标四级归档）：**127569 条记录**（其中 **95760 条电话已核实**，**31809 条待核实**），拆为 **46 个国标大类**（含未归类）：
...
| 29 橡胶和塑料制品业 | 6785 | 3356 | 3429 |
| 30 非金属矿物制品业 | 149 | 133 | 16 |
| 31 黑色金属冶炼和压延加工业 | 1806 | 1631 | 175 |
| 32 有色金属冶炼和压延加工业 | 1574 | 1161 | 413 |
| 33 金属制品业 | 9389 | 6388 | 3001 |
| 34 通用设备制造业 | 13195 | 8764 | 4431 |
| 35 专用设备制造业 | 5353 | 2284 | 3069 |
| 36 汽车制造业 | 97 | 74 | 23 |
...
| 40 仪器仪表制造业 | 58 | 34 | 24 |
| 42 废弃资源综合利用业 | 2 | 2 | 0 |
| 51 批发业 | 2732 | 2322 | 410 |
| 52 零售业 | 795 | 680 | 115 |

**英文数据集**（`data/en/gb/`，与中文同构的国标归档）：**100489 条英文镜像**，与中文按 `id` 一一对应（`en_backfill.py` 增量补齐 + `en_sync_industry.py` 补 `industry_en` 标签），供海外 Agent/买家使用。

覆盖地区：27 个城市——长三角（苏州、宁波、上海、无锡、杭州、嘉兴等）、珠三角（东莞、深圳、佛山、广州等），明细见 `data/region-index.json`。
...
- **125451 / 127569 条已归类**，覆盖 **267 个国标小类码**（另有个别记录只精确到大类/中类，归入 `_partial.json`）；2118 条未归类（公司名无行业信号，或所属门类尚未登记 schema：建筑/运输/金融/房地产/商务服务/教育/卫生）
...
大类分布：餐饮业 38841、居民服务业 18027、通用设备制造业 13195、金属制品业 9389、机动车、电子产品和日用产品修理业 8647、住宿业 7258。
