...
[![Records](https://img.shields.io/badge/records-29942-58a6ff)](data/)
...
> ⚠️ 仓库内 `skills/vendors/*/SKILL.md` 是**供应商数据卡**（供检索命中后阅读），
> 不是可独立安装的 Skill；本仓库的 Skill 入口只有根目录 `SKILL.md` / `SKILL_EN.md`。

## 数据现状

**中文数据集**（`data/gb/`，国标四级归档）：**29942 条记录**（其中 **19895 条电话已核实**，**10047 条待核实**），拆为 **23 个国标大类**（含未归类）：
...
| 26 化学原料和化学制品制造业 | 620 | 391 | 229 |
| 29 橡胶和塑料制品业 | 2405 | 1135 | 1270 |
| 30 非金属矿物制品业 | 10 | 7 | 3 |
| 31 黑色金属冶炼和压延加工业 | 1103 | 1009 | 94 |
| 32 有色金属冶炼和压延加工业 | 1004 | 752 | 252 |
| 33 金属制品业 | 7548 | 5011 | 2537 |
| 34 通用设备制造业 | 10748 | 7214 | 3534 |
| 35 专用设备制造业 | 2039 | 963 | 1076 |
| 36 汽车制造业 | 44 | 28 | 16 |
| 37 铁路、船舶、航空航天和其他运输设备制造业 | 6 | 3 | 3 |
| 38 电气机械和器材制造业 | 102 | 77 | 25 |
| 39 计算机、通信和其他电子设备制造业 | 1451 | 981 | 470 |
| 40 仪器仪表制造业 | 43 | 29 | 14 |
| 42 废弃资源综合利用业 | 2 | 2 | 0 |
| 51 批发业 | 1802 | 1531 | 271 |
| 52 零售业 | 4 | 3 | 1 |

**英文数据集**（`data/en/gb/`，与中文同构的国标归档）：**29942 条英文镜像**，与中文按 `id` 一一对应（`en_backfill.py` 增量补齐 + `en_sync_industry.py` 补 `industry_en` 标签），供海外 Agent/买家使用。
...
- **28981 / 29942 条已归类**，覆盖 **117 个国标小类码**（另有个别记录只精确到大类/中类，归入 `_partial.json`）；961 条未归类（公司名无行业信号，或属于本数据集不覆盖的门类）
...
| 3484 | 机械零部件加工 | 7959 |
| 3311 | 金属结构制造 | 2252 |
| 2929 | 塑料零件及其他塑料制品制造 | 2197 |
| 3360 | 金属表面处理及热处理加工 | 2016 |
| 3399 | 其他未列明金属制品制造 | 1896 |
| 3525 | 模具制造 | 1842 |
| 3130 | 钢压延加工 | 1103 |
| 3482 | 紧固件制造 | 1021 |
| 3989 | 其他电子元件制造 | 933 |
...
大类分布：通用设备制造业 10748、金属制品业 7548、橡胶和塑料制品业 2405、专用设备制造业 2039、批发业 1802、计算机、通信和其他电子设备制造业 1451。
