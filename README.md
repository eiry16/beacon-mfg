...
[![Records](https://img.shields.io/badge/records-10781-58a6ff)](data/)
...
**中文数据集**（`data/suppliers/`）：**10781 条记录**，覆盖 8 个品类（其中 **6285 条电话已核实**，**4496 条待核实**）：

| 品类 | 总记录 | 电话已核实 | 待核实 |
|---|---|---|---|
| 精密机械加工 | 2093 | 1087 | 1006 |
| 钣金冲压 | 1212 | 854 | 358 |
| 注塑成型 | 1532 | 699 | 833 |
| 压铸 | 419 | 197 | 222 |
| 电子元器件 | 645 | 291 | 354 |
...
**英文数据集**（`data/en/`）：**10781 条英文镜像**，供海外 Agent/买家使用（与中文 10781 条一一对应，2026-09-08 完成全量对齐）。

覆盖地区：18 个城市——长三角（苏州 1347 家、宁波 1166 家、上海 932 家、无锡 856 家、嘉兴 651 家等）、珠三角（东莞 1108 家、深圳 920 家、佛山 824 家、广州 669 家等）。

> 检索优化：按城市查询请使用 `data/region-index.json`（地区索引）快速定位，无需全量扫描品类文件。
