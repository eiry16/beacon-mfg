...
[![Records](https://img.shields.io/badge/records-14625-58a6ff)](data/)
...
**中文数据集**（`data/suppliers/`）：**14625 条记录**，覆盖 8 个品类（其中 **8894 条电话已核实**，**5731 条待核实**）：

| 品类 | 总记录 | 电话已核实 | 待核实 |
|---|---|---|---|
| 精密机械加工 | 3914 | 2132 | 1782 |
| 钣金冲压 | 1693 | 1258 | 435 |
| 注塑成型 | 1968 | 867 | 1101 |
| 压铸 | 464 | 226 | 238 |
| 电子元器件 | 657 | 299 | 358 |
...
**英文数据集**（`data/en/`）：**14625 条英文镜像**，供海外 Agent/买家使用（与中文记录按 `id` 一一对应；其中 14098 条带 `industry_en` 英文国标小类名，与中文归类数一致）。

覆盖地区：18 个城市——长三角（苏州、宁波、上海、无锡、嘉兴等）、珠三角（东莞、深圳、佛山、广州等），明细见 `data/region-index.json`。
...
- **14098 / 14625 条已归类**，覆盖 **47 个国标小类**；527 条未归类（公司名无行业信号，或属于本数据集不覆盖的门类）
...
|---|---|---|
| 3484 | 机械零部件加工 | 2735 |
| 2929 | 塑料零件及其他塑料制品制造 | 1589 |
| 3311 | 金属结构制造 | 1283 |
| 3360 | 金属表面处理及热处理加工 | 1259 |
| 3399 | 其他未列明金属制品制造 | 1247 |
| 3451 | 滚动轴承制造 | 652 |
| 3482 | 紧固件制造 | 642 |
| 3525 | 模具制造 | 621 |
| 5164 | 金属及金属矿批发（非制造） | 591 |
| 3483 | 弹簧制造 | 588 |
| 3989 | 其他电子元件制造 | 543 |
| 3392 | 有色金属铸造 | 391 |

大类分布：通用设备制造业 4694、金属制品业 4487、橡胶和塑料制品业 1724、批发业 908、专用设备制造业 634、计算机通信和其他电子设备制造业 560。
