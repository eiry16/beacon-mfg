...
[![Records](https://img.shields.io/badge/records-7962-58a6ff)](data/)
...
**中文数据集**（`data/suppliers/`）：**7962 条记录**，覆盖 8 个品类（其中 **4792 条电话已核实**，**3170 条待核实**）：
...
**英文数据集**（`data/en/`）：**7915 条英文镜像**，供海外 Agent/买家使用（中文数据完整对照；与中文 7962 条差 47 条——部分中文记录尚未生成英文镜像）。

覆盖地区：18 个城市——长三角（嘉兴 507 家、上海 666 家、苏州/宁波/无锡等）、珠三角（深圳 713 家、东莞 857 家、广州 396 家、佛山 545 家等）。
