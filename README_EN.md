...
- Data from **public sources only** (AMap POI, government lists, company websites,
...
- **Red lines**: we do not scrape B2B platforms (1688 etc.) or paid directories.
  Only official public APIs (AMap) and public listings.
...
| `scripts/fetch_gaode_poi.py` | AMap POI fetcher (paginated, incremental, masked on ingest) |
