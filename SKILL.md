...
用 `skills/registry/fingerprint/gb/{门类}/{大类}/{小类}.jsonl`——每家一行能力指纹，234 B，**覆盖全部 23698 家**。
...
- 当前 **15161 条电话已核实 + 8537 条待核实（合计 23698 条中文数据）**，另有英文镜像（`data/en/gb/`，见 `SKILL_EN.md`）
...
- **国标归档覆盖**：23698 条按 GB/T 4754 四级归档，22898 条已归入 **106 个小类**（800 条未归类）；
  制造业（C）21141 家、批发零售（F）1757 家；前三大类：金属制品（33）6473、通用设备（34）6330、橡塑（29）2332
