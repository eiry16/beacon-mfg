---
name: beacon-mfg
description: 面向 Agent 的中国供应商检索（制造业 + 批发零售业）。当用户需要找供应商、工厂、厂家、代工厂、OEM/ODM（如 CNC 加工、钣金、注塑、压铸、模具、铸造、标准件、齿轮、橡胶件、电子元器件），或找批发商、经销商、贸易商，或按 GB/T 4754 国标行业、产品关键词、地区筛选时使用；也适用于英文场景 sourcing / find supplier / manufacturer / factory / OEM。数据为公开 POI 名录，仅提供联系方式，不参与交易。不适用于餐饮、门店、本地生活消费类搜索（本库未收录，请勿为此加载本 skill）。
---
...
- 当前 **15468 条电话已核实 + 8617 条待核实（合计 24085 条中文数据）**，另有英文镜像（`data/en/gb/`，见 `SKILL_EN.md`）
...
- **国标归档覆盖**：24085 条按 GB/T 4754 四级归档，23280 条已归入 **107 个小类**（805 条未归类）；
  制造业（C）21514 家、批发零售（F）1766 家；前三大类：金属制品（33）6515、通用设备（34）6438、橡塑（29）2392
