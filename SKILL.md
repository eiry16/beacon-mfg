...
- 当前 **6285 条电话已核实 + 4496 条待核实记录（合计 10781 条中文数据）**，另有英文镜像（见 `SKILL_EN.md` / `data/en/`）
- 已核实记录 = 6285 条（`status="verified"`），联系电话可用；待核实记录 = 4496 条（`status="unverified_poi"`，真实企业 POI，电话待人工确认）
